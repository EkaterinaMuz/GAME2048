...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ endGame; }\n/* harmony export */ });\nfunction endGame(status) {\n  var gameBoard = document.querySelector('.game-board');\n  gameBoard.classList.add(status);\n  var message = document.createElement('p');\n  message.classList.add(\"\".concat(status, \"-message\"));\n  message.innerHTML = \"You \".concat(status, \"!<button class=\\\"btn btn-restart\\\">Try again</button>\");\n  gameBoard.append(message);\n  var restart = document.querySelector('.btn-restart');\n  restart.addEventListener('click', function () {\n    return location.reload();\n  });\n}\n\n//# sourceURL=webpack:///./scripts/endGame.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ updateScore; }\n/* harmony export */ });\n/* harmony import */ var _endGame__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./endGame */ \"./scripts/endGame.js\");\n\nfunction updateScore(cells) {\n  var gameScore = document.querySelector('.game__score');\n  var score = Math.max.apply(null, cells.flat().filter(function (cell) {\n    return cell.tile != null;\n  }) // находим непустые клетки\n  .reduce(function (acc, cell) {\n    var _cell$tile;\n    acc.push(cell === null || cell === void 0 ? void 0 : (_cell$tile = cell.tile) === null || _cell$tile === void 0 ? void 0 : _cell$tile.value);\n    return acc;\n  }, []) // сохраняем их значения в массив и находим большее\n  );\n\n  gameScore.textContent = score;\n  if (score === 2048) {\n    (0,_endGame__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('won');\n  }\n}\n\n//# sourceURL=webpack:///./scripts/updateScore.js?");
...
"use strict";
eval("module.exports = __webpack_require__.p + \"assets/keyboard-arrows.png\";\n\n//# sourceURL=webpack:///./assets/keyboard-arrows.png?");
